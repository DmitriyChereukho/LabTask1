...
namespace _Source.Game.Scripts
{
    public class ResourceCounterManager : MonoBehaviour
    {
        ...
        public void Init(ResourceBank resourceBank, ProductionLevels productionLevels)
        {
            ...
            foreach (GameResource resource in System.Enum.GetValues(typeof(GameResource)))
            {
                ...
                counter.GetComponent<ResourceVisual>().Init(_resourceBank, productionLevels, resource);
            }
